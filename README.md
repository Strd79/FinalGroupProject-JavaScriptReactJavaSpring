...
This was my final group project with CodeClan. My team consisted of Linsey Currie, TJ Pataria and myself. We had free rein to built an app of our choosing. We wanted to create a useful health app, which would use speech recognition. Our NHS Health App hooks into the NHS A-Z API and pulls information on health conditions, which can be searched, through text or speech. 
